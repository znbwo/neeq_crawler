 ...
 */
public class HeXunMacroReportCrawlerTask extends BasicHeXunYanBaoCrawlerTask {
    private final Logger log = LoggerFactory.getLogger(HeXunMacroReportCrawlerTask.class);
    private final String baseUrl = "http://yanbao.stock.hexun.com/listnews4_1.shtml";
    private final String redisKey = Constant.Redis.RESEARCH_REPORT_HEXUN_QUEUE;
    private final String kafkaTopic = Constant.Topic.MACRO_REPORT_HEXUN_TOPIC;

    public HeXunMacroReportCrawlerTask(PushQueue pushQueue, FileUploader fileUploader, CoopRedis redis) {
