 ...
 */
public class HeXunNewStockReportCrawlerTask extends BasicHeXunYanBaoCrawlerTask {
    private final Logger log = LoggerFactory.getLogger(HeXunNewStockReportCrawlerTask.class);
    private final String baseUrl = "http://yanbao.stock.hexun.com/listnews6_1.shtml";
    private final String redisKey = Constant.Redis.RESEARCH_REPORT_HEXUN_QUEUE;
    private final String kafkaTopic = Constant.Topic.NEW_STOCK_REPORT_HEXUN_TOPIC;

    public HeXunNewStockReportCrawlerTask(PushQueue pushQueue, FileUploader fileUploader, CoopRedis redis) {
